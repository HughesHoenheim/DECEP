    ...
    <main>
        ...
        <div class="slider-area ">
            ...
            <div class="slider-active">
                    <div class="single-slider slider-height" data-background="../commons/decep_images/image.jpg">
...
<!--                                    <img src="assets/img/hero/hero_man.png" alt="">-->
                                        <img src="../commons/decep_images/lobo-grande2.png" alt="" >
                                </div>
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-6">
                        <div class="single-category mb-30">
                            <div class="category-img">
                                <img src="../commons/decep_images/cursos/empresarismo1.jpg" alt="" width="370" height="320">
                     ...
                     <div class="col-xl-4 col-lg-6">
                        <div class="single-category mb-30">
                            <div class="category-img text-center">
                                <img src="../commons/decep_images/cursos/continua.jpg" alt="" width="370" height="320">
                                <div class="category-caption">
...
-->
                    ...
                    <div class="col-xl-4 col-lg-6">
                        <div class="single-category mb-30">
                            <div class="category-img">
                                <img src="../commons/decep_images/cursos/gerenciasuper1.jpeg" alt="" width="370" height="320">
                                <div class="category-caption">
<!--                                    <h2>Man`s Cloth</h2>-->
...
-->
        ...
        <div class="best-product-area lf-padding" >
           <div class="product-wrapper bg-height" style="background-image: url('../commons/decep_images/unnamed.jpg')">
                <div class="container position-relative">
                    <div class="row justify-content-between align-items-end">
                        <div class="product-man position-absolute  d-none d-lg-block">
                            <img src="../commons/decep_images/estudiante.png" alt="" width="300" height="620">
                        </div>
           ...
           <div class="shape bounce-animate d-none d-md-block">
               <img src="../commons/decep_images/diploma.png" alt="" width="150" height="150">
           </div>
        </div>
        <!-- Best Product End-->
...
-->
        ...
        include('../commons/includes/footer.html');
